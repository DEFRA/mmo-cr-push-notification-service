# MMO Catch Recording — Push Notification Service (Project Guidelines)

This repository holds the source code for the **MMO Catch Recording Push Notification Service**, a backend
...
(including [Push Notification Developer](.github/agents/push-notification-developer.agent.md),
[Push Notification Planner](.github/agents/push-notification-planner.agent.md),
[Push Notification Orchestrator](.github/agents/push-notification-orchestrator.agent.md) and
[Push Notification Code Reviewer](.github/agents/push-notification-code-reviewer.agent.md)).
...
4. **Plan** — For **Complex** work, delegate planning to the designated planning agent (for backend
   implementation, [Push Notification Planner](.github/agents/push-notification-planner.agent.md)), which returns a complete
...
```
mmo-cr-push-notification-service/
├── src/
