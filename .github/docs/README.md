...
├── agents/
│   ├── push-notification-orchestrator.agent.md
│   ├── push-notification-planner.agent.md
│   ├── push-notification-developer.agent.md
│   └── push-notification-code-reviewer.agent.md
├── instructions/
...
Agent names are **service-scoped** (`Push Notification Orchestrator`, `Push Notification Planner`, `Push Notification Developer`,
`Push Notification Code Reviewer`) so they stay unique when several Catch Recording repositories are open in the same
...
| Property       | Value                                                                                                                     |
| -------------- | ------------------------------------------------------------------------------------------------------------------------- |
| File           | `agents/push-notification-orchestrator.agent.md`                                                                          |
...
| Property       | Value                                                                           |
| -------------- | ------------------------------------------------------------------------------- |
| File           | `agents/push-notification-planner.agent.md`                                     |
...
| Property       | Value                                                                                                                   |
| -------------- | ----------------------------------------------------------------------------------------------------------------------- |
| File           | `agents/push-notification-developer.agent.md`                                                                           |
...
| Property       | Value                                                                                                 |
| -------------- | ----------------------------------------------------------------------------------------------------- |
| File           | `agents/push-notification-code-reviewer.agent.md`                                                     |
...
Select `Push Notification Orchestrator` in VS Code agent mode.
...
Select `Push Notification Developer` in VS Code agent mode.
...
Is the change trivial?
  (typo, doc, single config value, obvious small fix, missing test for known behaviour)
        │
       Yes ──► Push Notification Developer directly — Read → Implement → Test → Summarise
        │
        No
        │
...
or the published API contract?
        │
       Yes ──► Push Notification Orchestrator — Plan → Approval → Implement → (optional) Review
        │
        No  ──► Push Notification Developer directly (Standard: lightweight inline plan → approval → implement).
