...
- **The planner performs this single research pass** to validate those steps before returning the plan: the
  **Push Notification Planner** for Complex work, or the **Push Notification Developer** when it produces the lightweight inline plan
...
**revise** / **blocked**) so the plan can be finalised against it. When the **Push Notification Planner** produced the
